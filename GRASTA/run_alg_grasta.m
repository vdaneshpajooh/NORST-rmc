...
%%% GRASTA parameters
subsampling                 = 0.9;   % how much patial information will be used in your application
OPTIONS.RANK                = 30;     % the estimated rank
OPTIONS.rho                 = 1.8;
...
for i = 1:nframes
  ...
  L_hat_grasta(:,i) = L_hat;
  S_hat_grasta(:,i) = S_hat;
